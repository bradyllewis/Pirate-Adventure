...
- (void)viewDidLoad
{
    ...
    ZZZFactory *factory = [[ZZZFactory alloc] init];
...
- (IBAction)actionButtonPressed:(UIButton *)sender {
    ZZZTile *tile = [[self.tiles objectAtIndex:self.currentPoint.x] objectAtIndex:self.currentPoint.y];
...
-(void)updateTile
{
    ZZZTile *tileModel = [[self.tiles objectAtIndex:self.currentPoint.x] objectAtIndex:self.currentPoint.y];
...
-(void)updateCharacterStatsForArmor:(ZZZArmor *)armor withWeapons:(ZZZWeapon *) weapon withHealthEffect:(int)healthEffect
{
    if(armor != nil){
